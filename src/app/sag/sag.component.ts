...
import { SagResultDialogComponent } from './sag-result-dialog.component';
...
export class SagComponent implements OnInit {
	...
	getSagRear() {
		...
		this.openResultDialog('rear');
	}

	openResultDialog(type: string): void {
		this.dialog.open(SagResultDialogComponent, {
			...
			data: type === 'rear'
				? {
					title: 'SAG.REAR',
					type: this.type,
					sagE: this.dataSourceRear.sagE,
					sagD: this.dataSourceRear.sagD,
					msgE: this.dataSourceRear.msgE,
					msgD: this.dataSourceRear.msgD,
					errorE: this.dataSourceRear.errorE,
					errorD: this.dataSourceRear.errorD,
					dark: this.nav?.dark || false
				}
				: {
					title: 'SAG.FRONT',
					type: this.type,
					sagE: this.dataSourceFront.sagE,
					sagD: this.dataSourceFront.sagD,
					msgE: this.dataSourceFront.msgE,
					msgD: this.dataSourceFront.msgD,
					errorE: this.dataSourceFront.errorE,
					errorD: this.dataSourceFront.errorD,
					dark: this.nav?.dark || false
				}
		});
